...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            Group{
                NavigationLink(destination: View_Register().environmentObject(model_Auth)) { Text("Pack opening") }.background(RoundedRectangle(cornerRadius: 50)
                ...
                NavigationLink(destination: View_Register().environmentObject(model_Auth)) { Text("Card collection") }.background(RoundedRectangle(cornerRadius: 50)
                    .foregroundColor(colorScheme == .dark ? Color(red: 100 / 255, green: 100 / 255, blue: 100 / 255) : Color(red: 220 / 255, green: 220 / 255, blue: 220 / 255)))
